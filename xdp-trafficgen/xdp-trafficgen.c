...
const struct xsk_opts defaults_udp_xsk = {
...
struct prog_option udp_xsk_options[] = {
...
static int do_udp_xsk(const void *cfg, __unused const char *pin_root_path)
{
...
int do_help(__unused const void *cfg, __unused const char *pin_root_path)
{
	fprintf(stderr,
		...
		"       udp         - run in UDP mode\n"
		"       udp-xsk     - run in UDP mode (using AF_XDP sockets)\n"
		"       tcp         - run in TCP mode\n"
...
static const struct prog_command cmds[] = {
	...
	DEFINE_COMMAND_NAME("udp-xsk", udp_xsk, "Run in UDP mode (using AF_XDP sockets)"),
